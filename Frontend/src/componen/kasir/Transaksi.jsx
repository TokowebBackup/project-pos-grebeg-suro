      ...
      {selectedTransaction && (
        <Card sx={{ mt: 3 }}>
          ...
          <Box sx={{ p: 2 }}>
            ...
            <Typography variant="body1">
              <strong>Nama Customer:</strong> {selectedTransaction?.customer_name || 'Tidak diketahui'}
            </Typography>
            <Typography variant="body1">
              <strong>Telepon Customer:</strong> {selectedTransaction?.customer_phone || 'Tidak diketahui'}
            </Typography>
            <Typography variant="body1">
