            ...
            <>
              ...
              <Box sx={{ mb: 3 }}>
                ...
                <Paper sx={{ p: 2 }}>
                  ...
                  <Typography><strong>Customer Name:</strong> {selectedTransaction?.customer_name}</Typography>
                  <Typography><strong>Customer Phone:</strong> {selectedTransaction?.customer_phone}</Typography>
